// app/marketplace/saved/page.tsx
      ...
      <main className="relative z-10 mx-auto max-w-6xl px-4 py-8">
        ...
        <header className="mb-4">
          ...
          <p className="mt-1 text-xs text-slate-400">
            Items you&apos;ve marked as favourites.
          </p>
        </header>

        {savedItems.length === 0 ? (
          <p className="text-sm text-slate-400">
            You haven&apos;t saved (any listings yet. On the marketplace, click
            the star icon on a card to add it here.
          </p>
        ) : (
